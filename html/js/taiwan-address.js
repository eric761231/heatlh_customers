...
const TAIWAN_ADDRESS = {
    ...
    '新竹市': ['東區', '北區', '香山區'],
    '新竹縣': ['竹北市', '湖口鄉', '新豐鄉', '新埔鎮', '關西鎮', '芎林鄉', '橫山鄉', '北埔鄉', '寶山鄉', '竹東鎮', '五峰鄉', '尖石鄉', '峨眉鄉'],
    '苗栗縣': ['苗栗市', '頭份市', '竹南鎮', '後龍鎮', '通霄鎮', '苑裡鎮', '造橋鄉', '西湖鄉', '頭屋鄉', '公館鄉', '大湖鄉', '泰安鄉', '銅鑼鄉', '三義鄉', '西湖鄉', '卓蘭鎮', '獅潭鄉', '三灣鄉', '南庄鄉'],
    '彰化縣': ['彰化市', '員林市', '和美鎮', '鹿港鎮', '溪湖鎮', '二林鎮', '田中鎮', '北斗鎮', '花壇鄉', '芬園鄉', '大村鄉', '永靖鄉', '伸港鄉', '線西鄉', '福興鄉', '秀水鄉', '埔心鄉', '埔鹽鄉', '大城鄉', '芳苑鄉', '竹塘鄉', '埤頭鄉', '溪州鄉'],
...
function getDistrictsByCity(city) {
    return TAIWAN_ADDRESS[city] || [];
}

// 取得所有縣市列表
function getAllCities() {
    return Object.keys(TAIWAN_ADDRESS);
}
